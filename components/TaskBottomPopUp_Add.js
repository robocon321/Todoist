...
import { StyleSheet, View, Text, Dimensions, Image, TextInput, Modal, TouchableWithoutFeedback, KeyboardAvoidingView } from "react-native";
...
const Label = (key) =>{
    return <Text style={styles.tag} key={key}>@Label</Text>
}

const Project = (key) =>{
    return <Text style={styles.tag} key={key}>#Project</Text>
}

const Date = (key) =>{
    return <Text style={styles.tag} key={key}>Date</Text>
}
    ...
    constructor(props){
        ...
        this.state = {
            ...
            inputAddTask: [              
                ...
                {
                    component: (key) => <TextInput key={key} autoFocus placeholder="@Label, #Project"/>
                }
            ],
            label: ["a", "b", "c"],
            project: ["p1", "p2", "p3"]
                    ...
                    >
                        ...
                        <View style={styles.row}>
                            <View style={styles.wrap}>
                                <Image source={ICON.calendar} style={[styles.icon, {tintColor: COLOR.green_dark}]}/>
                                <Text style={[styles.text, {color: COLOR.green_dark}]}>Today</Text>
                            </View>
                            <View style={styles.wrap}>
                                <Image source={ICON.inbox} style={[styles.icon, {tintColor: COLOR.blue_dark}]}/>
                        ...
                        <View style={[styles.row,{justifyContent:"space-between", alignItems:"center"}]}>
                            ...
                            <View style={[styles.row, styles.right]}>
                                <Image style={[styles.iconOption, {tintColor: COLOR.white}]} source={ICON.send}/>
                            </View>
                        </View>
                    </View>
                </View>
